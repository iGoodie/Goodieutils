...
public class QuadTree<T extends Entity> {
	...
	public ArrayList<T> query(T entity, float radius) {
		Circle q = new Circle(entity.position.x, entity.position.y, radius);
		return query(q);
	}
